		...
		<div class="col-md-8">				
				<div class="panel panel-primary">
					...
					<div class="panel panel-body">
						We provide different services with affortable price in Nepal. You can travel with Haice, Bus and Scorpio in different places of Nepal. Our moto is to provide best and luxrious travilling experience to our customers in affortable price. 
					</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel panel-body">
						Our vision to provide quality services in travelling sector of Nepal where passenger can consume this services in affortable price.
					</div>
				</div>
				...
				<div class="panel panel-primary">
					...
					<div class="panel panel-body">
						Our mission to became one of the best travel company of Nepal who provides quality services in affortable price.
					</div>
				</div>
