		...
		<div class="col-md-4">
			<div class="panel panel-primary">
				<div class="panel panel-heading">
					...
					<button class="btn btn-danger btn-lg btn-block" onclick="window.open('subscribe.php','_self')">Subscribe Info</button>
		...
		<div class="col-md-8">
			<div class="panel panel-info">
				...
				<div class="panel panel-body">
					<p>
						This is dashboard of the site which can help you to update gallery, post, reservation and subcription in easily. 
					</p>
